...
class BinanceRestClient:
    ...
    async def _request(self, method: str, endpoint: str, 
                      signed: bool = False, **kwargs) -> Union[Dict, List]:
        """Make an API request.
    ...
    async def get_open_orders(self, symbol: Optional[str] = None) -> List[Dict]:
        ...
        if symbol is not None:
            params["symbol"] = symbol
        return await self._request("GET", f"/api/v3/openOrders", signed=True, params=params)
    ...
    async def cancel_all_orders(self, symbol: str) -> Dict:
        ...
        Returns:
            Order cancellation response
        """
        return await self._request("DELETE", f"/api/v3/openOrders", signed=True, params={"symbol": symbol})
    
    async def get_my_trades(self, symbol: str, order_id: Optional[int] = None, start_time: Optional[int] = None, end_time: Optional[int] = None, from_id: Optional[int] = None, limit: Optional[int] = None) -> List[Dict]:
        """Get user's trades.
    ...
    async def get_agg_trades(self, symbol: str, from_id: Optional[int] = None, start_time: Optional[int] = None, end_time: Optional[int] = None, limit: Optional[int] = None) -> List[Dict]:
        ...
        if limit is not None:
            params["limit"] = limit
        return await self._request("GET", f"/api/v3/aggTrades", signed=False, params=params)
    
    async def get_klines(self, symbol: str, interval: str, start_time: Optional[int] = None, end_time: Optional[int] = None, time_zone: Optional[int] = 0, limit: Optional[int] = 500) -> List[List[float]]:
        """Get klines.
